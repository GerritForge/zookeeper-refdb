...
public class ZookeeperConfig {
  ...
  public ZookeeperConfig(PluginConfigFactory cfgFactory, @PluginName String pluginName) {
    ...
    isSshEnabled = getBoolean( zkConfig,
            SECTION,
            SUBSECTION, SSL_CONNECTION, DEFAULT_SSH_CONNECTION);
    
    sslKeyStoreLocation =
            getString(zkConfig, SECTION, SUBSECTION, SSL_KEYSTORE_LOCATION, DEFAULT_SSL_KEYSTORE_LOCATION);
    
    sslTrustStoreLocation =
            getString(zkConfig, SECTION, SUBSECTION, SSL_TRUSTSTORE_LOCATION, DEFAULT_SSL_TRUSTSTORE_LOCATION);
    
    sslKeyStorePassword =
            getString(zkConfig, SECTION, SUBSECTION, SSL_KEYSTORE_PASSWORD, DEFAULT_SSL_KEYSTORE_PASSWORD);
    
    sslTrustStorePassword =
            getString(zkConfig, SECTION, SUBSECTION, SSL_TRUSTSTORE_PASSWORD, DEFAULT_SSL_TRUSTSTORE_PASSWORD);
  ...
  public CuratorFramework buildCurator() {
	if(isSshEnabled) {
		checkArgument(StringUtils.isNotEmpty(sslKeyStorePassword), "zookeeper.ssl.sslKeyStorePassword cannot be empty");
		checkArgument(StringUtils.isNotEmpty(sslTrustStorePassword), "zookeeper.ssl.sslTrustStorePassword cannot be empty");
  ...
  private Boolean getBoolean(Config cfg, String section, String subSection, String name, Boolean defaultValue) {
	    try {
