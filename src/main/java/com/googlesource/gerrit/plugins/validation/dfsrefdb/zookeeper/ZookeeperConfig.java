...
public class ZookeeperConfig {
  ...
  public ZookeeperConfig(Config zkConfig) {
    ...
    zkUsername = getString(zkConfig, SECTION, SUBSECTION, KEY_USERNAME, "globalrefdb");
    zkPassword = getString(zkConfig, SECTION, SUBSECTION, KEY_PASSWORD, "globalrefdb-secret");
