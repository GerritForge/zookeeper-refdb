...
public class ZookeeperConfig {
  ...
  @Inject
  public ZookeeperConfig(@GerritServerConfig Config gerritConfig, PluginConfigFactory cfgFactory, @PluginName String pluginName) {
    this(gerritConfig, cfgFactory.getGlobalPluginConfig(pluginName));
  }

  public ZookeeperConfig(Config gerritConfig, Config zkConfig) {
    log.error("Secure config is {}", String.join(",", gerritConfig.getSections()));
    connectionString =
    ...
    if (build == null) {
      CuratorFrameworkFactory.Builder builder =
          CuratorFrameworkFactory.builder()
              ...
              .namespace(root);
      log.error("zkUsername is: {}, zkPassword is: {}", zkUsername, zkPassword);
